...
async function interview() {
    ...
    console.log("Technical interview simulation starting. Type 'exit' any time to end the session.\n");
    console.log("The AI interviewer will ask you questions about the project. Answer as if you're in a real interview.\n");
